...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './reponse.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPONSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REPONSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REPONSE actions', async () => {
      const arg = { id: 364 };
    ...
    it('dispatches UPDATE_REPONSE actions', async () => {
      const arg = { id: 364 };
    ...
    it('dispatches PARTIAL_UPDATE_REPONSE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REPONSE actions', async () => {
      const arg = 42666;
