...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './test.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TEST actions', async () => {
      const arg = { id: 16262 };
    ...
    it('dispatches UPDATE_TEST actions', async () => {
      const arg = { id: 16262 };
    ...
    it('dispatches PARTIAL_UPDATE_TEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TEST actions', async () => {
      const arg = 42666;
